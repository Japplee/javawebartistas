        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getMethod().equals("POST")){
                if(request.getParameter("action").equals("agregar")) {
                    ...
                    artista.setEstilo(request.getParameter("estilo"));
                    artistas.add(artista);
                }
                
                if(request.getParameter("action").equals("editar")) {
                    artistas.get(Integer.parseInt(request.getParameter("id"))).setNombre(request.getParameter("nombre"));
                }
            }
            ...
            request.setAttribute("usuario", artistas);
